// ===============================================
// middleware для данных о погоде
// ===============================================
...
// добавляет данные о погоде в res.locals.partials
// эти данные будут доступны во ВСЕХ шаблонах
const weatherMiddleware = async (req, res, next) => {
    // имитация объекта partials, если его нет
  if (!res.locals.partials) res.locals.partials = {}

  // добавляем данные о погоде
  // В шаблонах доступны как {{partials.weatherContext}}
