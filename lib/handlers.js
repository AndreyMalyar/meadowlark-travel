...
exports.api = {
    ...
    vacationPhotoContest: (req, res, fields, files) => {
      ...
      // Проверка файла на Api - возвращает JSON с ошибкой
      if(!files.photo || files.photo[0].size === 0){
...
exports.vacationPhotoContestProcess = (req, res, fields, files) => {
    ...
    if(!files.photo || files.photo[0].size === 0){
        return res.redirect(303, '/contest/vacation-photo-error')
    }

    res.redirect(303, '/contest/vacation-photo-thank-you')
}

exports.vacationPhotoContestError = (req, res) => {
...
/*
field data:  { _csrf: [ '' ], name: [ 'andrey' ], email: [ 'andrey@example.com' ] }
files:  {
  photo: [
    {
      fieldName: 'photo',
      originalFilename: '',
      path: 'public\\uploads\\sWYReyBJ6rlzdUxhQRJWbhmn',
      headers: [Object],
      size: 0
    }
  ]
}
данные поля:  { _csrf: [ '' ], name: [ 'ali' ], email: [ 'ali@mail.ru' ] }
файлы:  {
  photo: [
    {
      fieldName: 'photo',
      originalFilename: '',
      path: 'C:\\Users\\User\\AppData\\Local\\Temp\\X6PsT-4bMpb8ZtlN48uwhXiw',
      headers: [Object],
      size: 0
    }
  ]
